...
export function TeamMemberCard({ member }: TeamMemberCardProps) {
  ...
  return (
    <Reveal as="article" className="h-full">
      <article className="group interactive-card flex h-full flex-col overflow-hidden rounded-lg border border-border bg-card">
        <Image
          src={member.image}
          alt={member.name}
          width={900}
        ...
        <div className="flex flex-1 flex-col p-5">
          <div className="flex items-start justify-between gap-3">
            <div>
              <h3 className="display-title min-h-[3.4rem] text-[1.7rem] leading-none">{member.name}</h3>
